...
as well as the numerous scripts corresponding to the examples discussed in the previous work, with numerous comments, in order to facilitate their use and modification.
